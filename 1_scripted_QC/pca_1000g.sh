...
plink19 --allow-no-sex --bfile $1_exome_aims --bmerge $parth/1000G/AIMs.1000G.v2.bed $parth/1000G/AIMs.1000G.v2.bim $parth/1000G/AIMs.1000G.v2.fam --make-bed --out $1_1000G_mer$
...
if [ $needsToBeFlip -gt 0 ]; then
   ...
   plink19 --allow-no-sex --bfile $1_flipped --bmerge $parth/1000G/AIMs.1000G.v2.bed $parth/1000G/AIMs.1000G.v2.bim $parth/1000G/AIMs.1000G.v2.fam --make-bed --out $1_1000G_mer$
fi
