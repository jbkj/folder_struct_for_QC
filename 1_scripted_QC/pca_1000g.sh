...
plink19 --bfile $1 --extract $parth/ExomeChip_AIMs.txt --make-bed --out $1_exome_aims


plink19 --bfile $1_exome_aims --bmerge $parth/1000G/AIMs.1000G.v2.bed $parth/1000G/AIMs.1000G.v2.bim $parth/1000G/AIMs.1000G.v2.fam --make-bed --out $1_1000G_merged
...
if [ $needsToBeFlip -gt 0 ]; then
   ...
   plink19 --bfile $1_flipped --bmerge $parth/1000G/AIMs.1000G.v2.bed $parth/1000G/AIMs.1000G.v2.bim $parth/1000G/AIMs.1000G.v2.fam --make-bed --out $1_1000G_merged
fi
